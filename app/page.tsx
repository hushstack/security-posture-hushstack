              ...
              >
                {[
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="relative px-4 sm:px-5 py-3 rounded-lg font-medium text-sm transition-all flex items-center gap-2 border cursor-pointer"
                    style={{
                      backgroundColor: scanMode === mode.id ? 'var(--background-card)' : 'transparent',
